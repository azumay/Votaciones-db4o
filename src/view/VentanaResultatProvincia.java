...
public class VentanaResultatProvincia extends JFrame {
	...
	public VentanaResultatProvincia() {
		setSize(600, 343);
		setTitle("Resultats per Provincia");
		setResizable(false);
	...
	private void initialize() {
		...
		JLabel lb1Titulo = new JLabel("RESULTATS PER PROVINCIA");
